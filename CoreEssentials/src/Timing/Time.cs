...
public static class Time
{
    ...
    /// <summary>
    /// Sets the delta time (in seconds) for the current frame.
    /// This method is intended for internal use by the main game loop (e.g., MainGame.Update).
    /// </summary>
    /// <param name="deltaTime">The time in seconds it took to complete the last frame. Must be non-negative.</param>
