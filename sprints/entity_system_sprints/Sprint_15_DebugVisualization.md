...
- [x] **T1: Create `DebugConfig` class (0.5 pt)** ⭐ User-facing
...
- [x] **T2: Create `EntityDebugDraw` class (1.5 pts)** 🔒 Internal
...
- [x] **T3: Add debug mode to `EntitySystem` (0.5 pt)** ⭐ User-facing
